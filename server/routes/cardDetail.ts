...
import { getCondition, createCondition, updateCondition, deleteCondition, createAbility, updateAbility, deleteAbility } from "../controller/cardDetailController.js";
...
router.put("/abilities/:abilityId", updateAbility);
