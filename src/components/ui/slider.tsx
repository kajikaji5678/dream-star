    ...
    >
      ...
      >
        <SliderPrimitive.Track
          ...
          className="relative grow overflow-hidden rounded-full bg-[#666970] select-none data-[orientation=horizontal]:h-1 data-[orientation=horizontal]:w-full data-vertical:h-full data-vertical:w-1"
        >
